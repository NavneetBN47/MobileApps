...
class Test_Suite_15_Cartridge_Memory_Error(object):
    ...
    def test_01_cartridge_cartridge_memoryerror_65542(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=65542, type="error")
        success = ErrorSimulatorCDM.cartridge_memoryerror_65542(self.error_manager, color="k")
        assert success, "Failed to set cartridge memory error"
