...
class Test_Suite_14_Cartridge_Verylow(object):
    ...
    @pytest.mark.selene
    def test_01_cartridge_verylowstop_66039(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=66039, type="error")
        success = ErrorSimulatorCDM.cartridge_verylowstop_66039(self.error_manager, color="k")
        assert success, "Failed to set cartridge very low stop error"
