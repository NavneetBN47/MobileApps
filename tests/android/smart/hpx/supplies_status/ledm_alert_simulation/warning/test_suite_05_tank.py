...
class Test_Suite_05_Tank(object):
    ...
    def test_01_validate_tanks_very_low_66018(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=66018,type="warning")
    ...
    def test_02_validate_tanks_very_low_66332(self, request):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=66332,type="warning")
