...
class Test_Suite_12_Non_Hp_Supply_Flow_Laser(object):
    ...
    def test_01_non_hp_supply_flow_66092(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=66092,type="info")
        success = InformationSimulatorLEDM.non_hp_supply_flow_66092(self.error_manager, color="k")
        assert success, "Failed to set non HP supply flow error"
