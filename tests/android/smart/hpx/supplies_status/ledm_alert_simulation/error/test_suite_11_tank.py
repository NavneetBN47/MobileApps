...
class Test_Suite_11_Tank(object):
    ...
    def test_01_validatefill_tanks_66019(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=66019, type="error")
    ...
    def test_02_validate_fill_tanks_66333(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=66333, type="error")
