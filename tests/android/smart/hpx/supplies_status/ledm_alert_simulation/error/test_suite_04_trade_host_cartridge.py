...
class Test_Suite_04_Trade_Host_Cartridge(object):
    ...
    def test_02_host_cartridge_when_expect_trade_65591(self):
        ...
        success = ErrorSimulatorLEDM.host_cartridge_when_expect_trade_65591(self.error_manager, color="y")
    ...
    def test_03_hp_altered_supply_65590_65592(self):
        alert_title, alert_icon, alert_body = self.fc.read_supplies_status_json_files(ioref=65590, type="error")
        success = ErrorSimulatorLEDM.hp_altered_supply_65590_65592(self.error_manager, color="y")
