...
class Test_Suite_01_Event_Service(object):
    @pytest.fixture(scope="class", autouse="true")
    def class_setup(cls, request, android_jweb_event_service_setup):
        cls = cls.__class__
        cls.driver, cls.fc = android_jweb_event_service_setup
    ...
    def test_05_delete_a_subscriber(self):
        """
    ...
    def test_06_delete_first_subscriber_from_subscriber_list(self, subscribers):
        """
    ...
    def test_07_delete_a_publisher(self):
        """
    ...
    def test_13_create_two_or_more_subscribers(self, subscribers_list):
        """
    ...
    def test_14_create_publisher_using_valid_and_invalid_publisher_id(self):
        """
