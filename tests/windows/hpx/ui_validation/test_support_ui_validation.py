...
class Test_Suit_Support_UI_Validation:
    @pytest.mark.applitools
    @screenshot_test("Smoke Test - Support Screen Layout")  
    def test_verify_support_screen_layout(self, eyes):
        """
        Navigate to the support screen and verify the layout of the screen.
        """
        ...
        navigation_panel.navigate_to_support()
