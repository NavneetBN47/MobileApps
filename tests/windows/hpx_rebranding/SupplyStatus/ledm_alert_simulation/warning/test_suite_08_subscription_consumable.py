...
class Test_Suite_08_Subscription_Consumable(object):
    ...
    def test_01_subscriptionconsumable_temporary_usage_allowed_65934(self):
        warning_title, warning_img, warning_detailed_info = self.fc.read_supplies_status_json_files(ioref=65934, type="warning")
        success = WarningSimulatorLEDM.subscriptionconsumable_temporary_usage_allowed_65934(self.error_manager, color="k")
