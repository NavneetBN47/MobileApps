...
class Test_Suite_07_Seho_At_Insertion(object):
    ...
    def test_01_seho_at_insertion_65613(self):
        warning_title, warning_img, warning_detailed_info = self.fc.read_supplies_status_json_files(ioref=65613, type="warning")
        success = WarningSimulatorLEDM.seho_at_insertion_65613(self.error_manager, color="y")
