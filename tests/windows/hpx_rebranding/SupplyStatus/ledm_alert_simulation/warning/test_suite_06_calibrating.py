...
class Test_Suite_06_Calibrating(object):
    ...
    def test_01_validate_calibration_required_65569(self):
        warning_title, warning_img, warning_detailed_info = self.fc.read_supplies_status_json_files(ioref=65569,type="warning")
        ...
        assert self.supplies_status.verify_align_btn()
