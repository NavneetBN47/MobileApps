...
class Test_Suite_05_Tank(object):
    ...
    def test_01_validate_tanks_very_low_66018(self):
        warning_title, warning_img, warning_detailed_info = self.fc.read_supplies_status_json_files(ioref=66018,type="warning")
        success = WarningSimulatorLEDM.tanks_very_low_66018(self.error_manager, color="y")
    ...
    def test_02_validate_tanks_very_low_66332(self, request):
        warning_title, warning_img, warning_detailed_info = self.fc.read_supplies_status_json_files(ioref=66332,type="warning")
        success = WarningSimulatorLEDM.tanks_very_low_66332(self.error_manager, color="y")
        assert success, "Failed to set upgradable supply error"
