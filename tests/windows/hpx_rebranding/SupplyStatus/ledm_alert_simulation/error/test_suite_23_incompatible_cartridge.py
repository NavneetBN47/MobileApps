...
class Test_Suite_23_Incompatible_Cartridge(object):
    ...
    def test_01_incompatible_cartridge(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65676, type="error")
        success = ErrorSimulatorLEDM.incompatible_cartridge(self.error_manager, color="k")
        assert success, "Failed to set incompatible_cartridge error"
