...
class Test_Suite_15_Cartridge_Empty(object):
    ...
    @pytest.mark.spark
    def test_01_validate_ink_cartridge_empty_65539(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65539, type="error")
        success = ErrorSimulatorLEDM.ink_cartridge_empty_65539(self.error_manager, color="y")
        assert success, "Failed to set ink_cartridge_empty_65539 error"
