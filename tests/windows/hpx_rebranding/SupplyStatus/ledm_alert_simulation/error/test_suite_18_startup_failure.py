...
class Test_Suite_18_Startup_Failure(object):
    ...
    def test_01_validate_startup_failure_65599(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65599, type="error")
        success = ErrorSimulatorLEDM.startup_failure_65599(self.error_manager,color='y')
        assert success, "Failed to set startup_failure_65599 error"
