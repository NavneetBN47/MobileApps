...
class Test_Suite_20_Defective_Memory_Laser(object):
    ...
    def test_01_defective_memory_66038(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66038, type="error")
        success = ErrorSimulatorLEDM.defective_memory_66038(self.error_manager,color="k")
        assert success, "Failed to set defective memory 66038 error"
