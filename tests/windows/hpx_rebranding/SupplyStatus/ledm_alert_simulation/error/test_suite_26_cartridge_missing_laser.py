...
class Test_Suite_26_Cartridge_Missing_Laser(object):
    ...
    def test_01_cartridge_missing_laser(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66034, type="error")
        success = ErrorSimulatorLEDM.cartridge_missing(self.error_manager, color="k")
        assert success, "Failed to set cartridge_missing error"
