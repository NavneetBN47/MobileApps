...
class Test_Suite_19_Close_Door(object):
    ...
    def test_01_validate_close_door_cover_65725(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65725, type="error")
        success = ErrorSimulatorLEDM.close_door_cover_65725(self.error_manager)
        assert success, "Failed to set close_door_cover_65725 error"
