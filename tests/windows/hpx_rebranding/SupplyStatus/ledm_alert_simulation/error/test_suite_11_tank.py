...
class Test_Suite_11_Tank(object):
    ...
    def test_01_validatefill_tanks_66019(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66019, type="error")
        success = ErrorSimulatorLEDM.fill_tanks_66019(self.error_manager, color="y")
        assert success, "Failed to set fill_tanks_66019 error"
    ...
    def test_validate_fill_tanks_66333(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66333, type="error")
        success = ErrorSimulatorLEDM.fill_tanks_66333(self.error_manager, color="y")
        assert success, "Failed to set fill_tanks_66333 error"
