...
class Test_Suite_11_Tank(object):
    ...
    def test_01_validate_printer_error_65541(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65541, type="error")
    ...
    def test_02_validate_shaid_ooi_too_early_65800(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65800, type="error")
