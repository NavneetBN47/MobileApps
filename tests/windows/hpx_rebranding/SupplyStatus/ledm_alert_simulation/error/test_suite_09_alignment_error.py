...
class Test_Suite_09_Alignment_Error(object):
    ...
    def test_01_non_hp_circuitry_detected_66341(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66341, type="error")
    ...
    def test_02_non_hp_chip_detected_66339(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66339, type="error")
