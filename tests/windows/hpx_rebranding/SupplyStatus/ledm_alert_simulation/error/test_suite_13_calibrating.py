...
class Test_Suite_13_Calibrating(object):
    ...
    def test_01_validate_calibrating_65571(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65571, type="error")
        success = ErrorSimulatorLEDM.calibrating_65571(self.error_manager, color="y")
        assert success, "Failed to set calibrating_65571 error"
        ...
        # no need to check color icon as there is no need to validate color icon as per spec
