...
class Test_Suite_10_Unsubscribed_State(object):
    ...
    def test_01_validate_unsubscribed_state_65765(self):
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65765, type="error")
        success = ErrorSimulatorLEDM.unsubscribed_state_install_new_instant_ink_supply_65765(self.error_manager, color="k")
        assert success, "Failed to set cartridge_problem_65765 error"
