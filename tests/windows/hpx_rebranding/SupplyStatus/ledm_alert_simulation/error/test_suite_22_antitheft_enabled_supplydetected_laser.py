...
class Test_Suite_22_Antitheft_Enabled_SupplyDetected_Lasaer(object):
    ...
    def test_01_antitheft_enabled_supplydetected_laser(self):    
        supply_error_title, supply_error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66035, type="error")
        success = ErrorSimulatorLEDM.antitheft_enabled_supplydetected(self.error_manager, color="k")
        assert success, "Failed to set antitheft_enabled_supplydetected error"
