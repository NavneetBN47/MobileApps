...
class Test_Suite_01_Cartridge_Very_Low(object):
    ...
    def test_01_validate_cartridges_very_low_66242(self):
        info_title, info_img, info_detailed_body = self.fc.read_supplies_status_json_files(ioref=66242, type="info")
    ...
    def test_02_validate_cartridges_very_low_66711(self):
        info_title, info_img, info_detailed_body = self.fc.read_supplies_status_json_files(ioref=66711, type="info")
    ...
    def test_03_validate_cartridge_very_low_66713(self):
        info_title, info_img, info_detailed_body = self.fc.read_supplies_status_json_files(ioref=66713, type="info")
