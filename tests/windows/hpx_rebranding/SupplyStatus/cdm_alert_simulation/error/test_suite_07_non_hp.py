...
class Test_Suite_07_Non_HP(object):
    ...
    def test_01_validate_nonhp_circuitry_detected_66341(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66341, type="error")
    ...
    def test_02_non_hp_chip_66339(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66339, type="error")
    ...
    @pytest.mark.jupiter
    def test_03_non_hp_chip_66339(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=66339, type="error")
        success = ErrorSimulatorCDM.non_hp_chip_66339(self.error_manager, color="k")
        assert success, "Failed to set non hp chip error"
        assert self.supplies_status.verify_printer_card_present()
