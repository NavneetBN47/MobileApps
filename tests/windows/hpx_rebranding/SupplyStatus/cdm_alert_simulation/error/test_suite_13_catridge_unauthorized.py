...
class Test_Suite_13_Cartridge_Unauthorized(object):
    ...
    @pytest.mark.selene
    def test_01_cartridge_unauthorized_65926(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65926, type="error")
        success = ErrorSimulatorCDM.cartridge_unauthorized_65926(self.error_manager, color="k")
        assert success, "Failed to set cartridge unauthorized error"
