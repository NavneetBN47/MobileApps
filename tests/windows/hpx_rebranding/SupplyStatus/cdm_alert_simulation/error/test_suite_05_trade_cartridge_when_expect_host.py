...
class Test_Suite_05_Trade_Cartridge_When_Expect_Host(object):
    ...
    def test_01_validate_trade_cartridge_when_expect_host_65590(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65590, type="error")
    ...
    def test_02_host_cartridge_when_expect_trade_65591(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65591, type="error")
