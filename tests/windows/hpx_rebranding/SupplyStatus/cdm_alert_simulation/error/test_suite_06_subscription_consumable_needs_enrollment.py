...
class Test_Suite_06_Subscription_Consumable_Needs_Enrollment(object):
    ...
    def test_01_validate_subscription_consumable_needs_enrollment_65765(self):
        error_title, error_img, error_detailed_info = self.fc.read_supplies_status_json_files(ioref=65765, type="error")
        success = ErrorSimulatorCDM.unsubscribedstate_inCompatible_ink_65765(self.error_manager, color="k")
        assert success, "Failed to set subscription consumable needs enrollment error"
