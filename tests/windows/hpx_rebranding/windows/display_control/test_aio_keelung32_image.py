...
class Test_Suite_DisplayControl_Images(object):
    ...
    def test_01_figma_C51245194(self):
        ...
        image_compare_result = self.fc.get_screenshot_comparison_result(self.fc.fd["display_control"].verify_display_control_card_lone_image,machine_type="keelung32")
        ...
        image_compare_result = self.fc.get_screenshot_comparison_result(self.fc.fd["display_control"].verify_display_control_card_ltwo_page,machine_type="keelung32")
        # Only assert if screenshot comparison actually happened
        if image_compare_result is not None:
