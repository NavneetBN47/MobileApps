...
pytest.app_info = "HPX"
class Test_Suite_Bug_Regression_5650_part2(object):
    ...
    @pytest.mark.testrail("S57581.C65753095")
    def test_01_hpx_rebranding_C65753095(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753095
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("KR", 134, "ko")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753096")
    def test_02_hpx_rebranding_C65753096(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753096
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("LT", 141, "lt")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753097")
    def test_03_hpx_rebranding_C65753097(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753097
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("LV", 140, "lv")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753104")
    def test_04_hpx_rebranding_C65753104(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753104
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("NO", 177, "nb")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753118")
    def test_05_hpx_rebranding_C65753118(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753118
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("NL", 176, "nl-NL")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753121")
    def test_06_hpx_rebranding_C65753121(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753121
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("PL", 191, "pl")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753122")
    def test_07_hpx_rebranding_C65753122(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753122
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("BR", 55, "pt-BR")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753124")
    def test_08_hpx_rebranding_C65753124(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753124
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("PT", 193, "pt-PT")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753126")
    def test_09_hpx_rebranding_C65753126(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753126
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("RO", 184, "ro")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753128")
    def test_10_hpx_rebranding_C65753128(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753128
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("RU", 203, "ru-RU")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753129")
    def test_11_hpx_rebranding_C65753129(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753129
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("SK", 143, "sk")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753131")
    def test_12_hpx_rebranding_C65753131(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753131
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("SI", 212, "sl")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753132")
    def test_13_hpx_rebranding_C65753132(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753132
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("SE", 221, "sv-SE")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753133")
    def test_14_hpx_rebranding_C65753133(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753133
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("TH", 227, "th")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753135")
    def test_15_hpx_rebranding_C65753135(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753135
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("TR", 235, "tr")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753255")
    def test_16_hpx_rebranding_C65753255(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753255
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("UA", 241, "uk")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65753256")
    def test_17_hpx_rebranding_C65753256(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65753256
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("CN", 45, "zh-Hans-CN")
    ...
    def test_18_hpx_rebranding_C65753257(self):
        ...
        """
        self.__verify_search_items_localize_when_click_region_list_mulitple_times("HK", 237, "zh-Hant-HK")
