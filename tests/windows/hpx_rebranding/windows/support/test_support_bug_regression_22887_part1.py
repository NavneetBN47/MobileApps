...
pytest.app_info = "HPX"
class Test_Suite_Bug_Regression_22887_part1(object):
    ...
    @pytest.mark.testrail("S57581.C65851986")
    def test_01_hpx_rebranding_C65851986(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65851986
        """
        self.__click_link_need_help_sn("SA", 205, "ar-SA")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65851987")
    def test_02_hpx_rebranding_C65851987(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65851987
        """
        self.__click_link_need_help_sn("BG", 35, "bg")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65851989")
    def test_03_hpx_rebranding_C65851989(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65851989
        """
        self.__click_link_need_help_sn("CZ", 75, "cs")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65851991")
    def test_04_hpx_rebranding_C65851991(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65851991
        """
        self.__click_link_need_help_sn("DK", 61, "da")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65852013")
    def test_05_hpx_rebranding_C65852013(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65852013
        """
        self.__click_link_need_help_sn("DE", 94, "de-DE")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65852014")
    def test_06_hpx_rebranding_C65852014(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65852014
        """
        self.__click_link_need_help_sn("GR", 98, "el")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65852016")
    def test_07_hpx_rebranding_C65852016(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65852016
        """
        self.__click_link_need_help_sn("GB", 242, "en-GB")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65852020")
    def test_08_hpx_rebranding_C65852020(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65852020
        """
        self.__click_link_need_help_sn("ES", 128, "es-ES")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65852206")
    def test_09_hpx_rebranding_C65852206(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65852206
        """
        self.__click_link_need_help_sn("EE", 233, "et")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65852952")
    def test_10_hpx_rebranding_C65852952(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65852952
        """
        self.__click_link_need_help_sn("FI", 77, "fi")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853033")
    def test_11_hpx_rebranding_C65853033(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853033
        """
        self.__click_link_need_help_sn("CA", 39, "fr-CA")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853051")
    def test_12_hpx_rebranding_C65853051(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853051
        """
        self.__click_link_need_help_sn("FR", 84, "fr-FR")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853054")
    def test_13_hpx_rebranding_C65853054(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853054
        """
        self.__click_link_need_help_sn("IL", 117, "he")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853060")
    def test_14_hpx_rebranding_C65853060(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853060
        """
        self.__click_link_need_help_sn("HR", 108, "hr-HR")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853078")
    def test_15_hpx_rebranding_C65853078(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853078
        """
        self.__click_link_need_help_sn("HU", 109, "hu")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853080")
    def test_16_hpx_rebranding_C65853080(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853080
        """
        self.__click_link_need_help_sn("IT", 118, "it-IT")

    @pytest.mark.require_stack(["dev", "itg"]) 
    @pytest.mark.testrail("S57581.C65853082")
    def test_17_hpx_rebranding_C65853082(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65853082
        """
        self.__click_link_need_help_sn("JP", 122, "ja")
    ...
    def test_18_hpx_rebranding_C65854845(self):
        ...
        """
        self.__click_link_need_help_sn("TW", 237, "zh-Hant-TW")
