...
pytest.app_info = "HPX"
class Test_Suite_Bug_Regression_5325_part2(object):
    ...
    @pytest.mark.testrail("S57581.C65725005")
    def test_01_hpx_rebranding_C65725005(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725005
        """
        self.__verify_no_results_found_localize("KR", 134, "ko")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725007")
    def test_02_hpx_rebranding_C65725007(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725007
        """
        self.__verify_no_results_found_localize("LT", 141, "lt")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725009")
    def test_03_hpx_rebranding_C65725009(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725009
        """
        self.__verify_no_results_found_localize("LV", 140, "lv")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725010")
    def test_04_hpx_rebranding_C65725010(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725010
        """
        self.__verify_no_results_found_localize("NO", 177, "nb")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725011")
    def test_05_hpx_rebranding_C65725011(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725011
        """
        self.__verify_no_results_found_localize("NL", 176, "nl-NL")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725012")
    def test_06_hpx_rebranding_C65725012(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725012
        """
        self.__verify_no_results_found_localize("PL", 191, "pl")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725013")
    def test_07_hpx_rebranding_C65725013(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725013
        """
        self.__verify_no_results_found_localize("BR", 55, "pt-BR")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725015")
    def test_08_hpx_rebranding_C65725015(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725015
        """
        self.__verify_no_results_found_localize("PT", 193, "pt-PT")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725387")
    def test_09_hpx_rebranding_C65725387(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725387
        """
        self.__verify_no_results_found_localize("RO", 184, "ro")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725472")
    def test_10_hpx_rebranding_C65725472(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725472
        """
        self.__verify_no_results_found_localize("RU", 203, "ru-RU")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725489")
    def test_11_hpx_rebranding_C65725489(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725489
        """
        self.__verify_no_results_found_localize("SK", 143, "sk")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725636")
    def test_12_hpx_rebranding_C65725636(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725636
        """
        self.__verify_no_results_found_localize("SI", 212, "sl")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725532")
    def test_13_hpx_rebranding_C65725532(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725532
        """
        self.__verify_no_results_found_localize("SE", 221, "sv-SE")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725605")
    def test_14_hpx_rebranding_C65725605(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725605
        """
        self.__verify_no_results_found_localize("TH", 227, "th")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725612")
    def test_15_hpx_rebranding_C65725612(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725612
        """
        self.__verify_no_results_found_localize("TR", 235, "tr")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725613")
    def test_16_hpx_rebranding_C65725613(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725613
        """
        self.__verify_no_results_found_localize("UA", 241, "uk")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725615")
    def test_17_hpx_rebranding_C65725615(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725615
        """
        self.__verify_no_results_found_localize("CN", 45, "zh-Hans-CN")

    @pytest.mark.require_stack(["dev", "itg", "production"])    
    @pytest.mark.testrail("S57581.C65725618")
    def test_18_hpx_rebranding_C65725618(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/65725618
        """
        self.__verify_no_results_found_localize("HK", 237, "zh-Hant-HK")
    ...
    def __verify_no_results_found_localize(self, country_code, country_nation, language):
        ...
        self.fc.fd["devices_support_pc_mfe"].input_country_select_edit("000")
        assert self.fc.fd["devices_support_pc_mfe"].get_country_select_text() != "No results found"
