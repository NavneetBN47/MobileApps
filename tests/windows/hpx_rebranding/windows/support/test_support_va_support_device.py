...
pytest.app_info = "HPX"
class Test_Suite_VA_Support_Device(object):
    ...
    def test_01_hpx_rebranding_C64746472(self): 
        ...
        self.fc.select_device(0)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746474")    
    def test_02_hpx_rebranding_C64746474(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746474
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.fc.select_device(1)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746439")    
    def test_03_hpx_rebranding_C64746439(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746439
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.fc.select_device(3)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C63794951")    
    def test_04_hpx_rebranding_C63794951(self): 
        """
        ...
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.fc.select_device(4)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746476")
    def test_05_hpx_rebranding_C64746476(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746476
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.__select_secondary_device(0)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746496")
    def test_06_hpx_rebranding_C64746496(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746496
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.__select_secondary_device(1)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746499")
    def test_07_hpx_rebranding_C64746499(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746499
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.__select_secondary_device(2)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746482")
    def test_08_hpx_rebranding_C64746482(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746482
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.__select_secondary_device(3)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == False

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746573")
    def test_09_hpx_rebranding_C64746573(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746573
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.__select_secondary_device(4)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746501")
    def test_10_hpx_rebranding_C64746501(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746501
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest008@gmx.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.__select_secondary_device(5)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746456")
    def test_11_hpx_rebranding_C64746456(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746456
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest007@protonmail.com", "hpsa@rocks_335")
        self.__back_to_device_page()
        self.fc.select_device(0)
        assert self.fc.fd["devices_support_pc_mfe"].verify_start_virtual_assist_btn() == True

    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746487")
    def test_12_hpx_rebranding_C64746487(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746487
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest007@protonmail.com", "hpsa@rocks_335")
        self.__back_to_device_page()
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746475")
    def test_13_hpx_rebranding_C64746475(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746475
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest007@protonmail.com", "hpsa@rocks_335")
        self.__back_to_device_page()
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746493")
    def test_14_hpx_rebranding_C64746493(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746493
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest007@protonmail.com", "hpsa@rocks_335")
        self.__back_to_device_page()
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746573")
    def test_15_hpx_rebranding_C64746573(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746573
        """ 
        self.fc.select_device()
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"])
    @pytest.mark.testrail("S57581.C64746509")
    def test_16_hpx_rebranding_C64746509(self): 
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/64746509
        """ 
        self.fc.select_device()
        self.__sign_in_HPX("shhpxtest007@protonmail.com", "hpsa@rocks_335")
        self.__back_to_device_page()
