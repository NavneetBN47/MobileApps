...
pytest.app_info = "HPX"
class Test_Suite_Update_With_Fusion(object):
    ...
    @pytest.mark.testrail("S57581.C74767021")
    def test_01_hpx_rebranding_C74767021(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767021
        """
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767025")
    def test_02_hpx_rebranding_C74767025(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767025
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767026")
    def test_03_hpx_rebranding_C74767026(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767026
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767027")
    def test_04_hpx_rebranding_C74767027(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767027
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767028")
    def test_05_hpx_rebranding_C74767028(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767028
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767029")
    def test_06_hpx_rebranding_C74767029(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767029
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767030")
    def test_07_hpx_rebranding_C74767030(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767030
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767031")
    def test_08_hpx_rebranding_C74767031(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767031
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767032")
    def test_09_hpx_rebranding_C74767032(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767032
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767048")
    def test_10_hpx_rebranding_C74767048(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767048
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767049")
    def test_11_hpx_rebranding_C74767049(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767049
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767050")
    def test_12_hpx_rebranding_C74767050(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767050
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
    ...
    @pytest.mark.require_stack(["dev", "itg", "production"]) 
    @pytest.mark.testrail("S57581.C74767051")
    def test_13_hpx_rebranding_C74767051(self):
        """
        https://hp-testrail.external.hp.com/index.php?/cases/view/74767051
        """
        ini_files = self.__remote_extract_zip_and_find_inf(
