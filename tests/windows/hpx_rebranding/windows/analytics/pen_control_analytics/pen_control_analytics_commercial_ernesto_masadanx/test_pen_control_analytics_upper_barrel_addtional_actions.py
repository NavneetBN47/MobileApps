...
class Test_Suite_Pen_Control_Upper_Barrel_Additional_Actions_Analytics(object):
    ...
    def test_01_pen_control_click_on_hover_click_toggle_switch_C52081602(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_upper_barrel_hover_click_toggle_lthree_page()
            time.sleep(1)
            self.fc.fd["pen_control"].click_upper_barrel_hover_click_toggle_lthree_page()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_click_on_more_actions_button_C52083677(self):
        # Get the current time as the starting time for an open search query.
        query_start_time = datetime.now(timezone.utc).isoformat()
    ...
    @pytest.mark.analytics
    def test_03_pen_control_click_on_edit_customization_button_C52083678(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_click_on_change_to_open_app_button_C52083679(self):
        self.fc.fd["pen_control"].click_customize_buttons()
        time.sleep(3)
        self.fc.fd["pen_control"].click_customize_upper_barrel_button()        
