...
class Test_Suite_Pen_Control_Slice4_Pen_Analytics(object):
    ...
    def test_01_pen_control_pen_onoff_radio_analytics_C52114961(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice4_pen_disabled_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_menu_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_fifth_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_fourth_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_middle_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_left_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_right_click_radio_button()           
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_erase_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_pen_onoff_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_pen_erase_radio_analytics_C52115184(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_pen_right_click_radio_analytics_C52114986(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_pen_left_click_radio_analytics_C52115046(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_pen_middle_click_radio_analytics_C52115104(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_pen_fourth_click_radio_analytics_C52115179(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_pen_fifth_click_radio_analytics_C52115368(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_pen_menu_radio_analytics_C52115639(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_pen_disabled_radio_analytics_C52115762(self):
