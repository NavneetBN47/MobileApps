...
class Test_Suite_Pen_Control_Topbutton_Singlepress_Additional_Actions_Analytics(object):
    ...
    def test_01_pen_control_click_on_more_actions_button_C52085802(self):
        ...
        self.fc.fd["pen_control"].click_customize_topbutton_singlepress()
    ...
    @pytest.mark.analytics
    def test_02_pen_control_click_on_change_to_open_app_button_C52085804(self):    
