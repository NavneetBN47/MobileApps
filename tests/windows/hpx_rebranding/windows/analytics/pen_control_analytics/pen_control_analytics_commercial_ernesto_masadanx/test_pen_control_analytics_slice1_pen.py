...
class Test_Suite_Pen_Control_Slice1_Pen_Analytics(object):
    ...
    def test_01_pen_control_pen_onoff_radio_analytics_C52088914(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice1_pen_disabled_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_menu_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_fifth_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_fourth_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_middle_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_left_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_right_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_erase_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_pen_onoff_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_pen_erase_radio_analytics_C52088951(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_pen_right_click_radio_analytics_C52088916(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_pen_left_click_radio_analytics_C52088923(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_pen_middle_click_radio_analytics_C52088949(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_pen_fourth_click_radio_analytics_C52088950(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_pen_fifth_click_radio_analytics_C52088952(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_pen_menu_radio_analytics_C52088955(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_pen_disabled_radio_analytics_C52088962(self):
