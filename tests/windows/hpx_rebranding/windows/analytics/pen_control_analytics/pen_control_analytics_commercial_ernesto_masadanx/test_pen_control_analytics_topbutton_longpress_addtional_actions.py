...
class Test_Suite_Pen_Control_Topbutton_Longpress_Additional_Actions_Analytics(object):
    ...
    def test_01_pen_control_click_on_more_actions_button_C52088883(self):
        ...
        time.sleep(3)
        self.fc.fd["pen_control"].click_customize_topbutton_longpress()
    ...
    @pytest.mark.analytics
    def test_02_pen_control_click_on_change_to_open_app_button_C52088884(self):
