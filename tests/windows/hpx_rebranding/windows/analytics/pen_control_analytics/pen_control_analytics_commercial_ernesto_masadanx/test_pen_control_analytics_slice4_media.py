...
class Test_Suite_Pen_Control_Slice4_Media_Analytics(object):
    ...
    def test_01_pen_control_media_playpause_radio_analytics_C52115970(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice4_media_mute_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_media_volume_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_media_volume_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_media_previous_track_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_media_next_track_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_media_playpause_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_media_next_track_radio_analytics_C52115971(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_media_previous_track_radio_analytics_C52115972(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_media_volume_up_radio_analytics_C52115973(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_media_volume_down_radio_analytics_C52115974(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_media_mute_audio_radio_analytics_C52115975(self):
