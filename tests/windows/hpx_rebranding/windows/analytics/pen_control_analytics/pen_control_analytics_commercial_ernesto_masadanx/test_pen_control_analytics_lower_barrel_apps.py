...
class Test_Suite_Pen_Control_Lower_Barrel_Apps_Analytics(object):
    ...
    def test_01_pen_control_apps_windows_search_radio_analytics_C52084218(self):
        ...
        for _ in range(5): 
            ...
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_button_web_browser_text()
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_button_switch_application_text()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_apps_ms_whiteboard_radio_analytics_C52084220(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_apps_screen_snipping_radio_analytics_C52084221(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_apps_switch_application_radio_analytics_C52084222(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_apps_web_browser_radio_analytics_C52084223(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_apps_email_radio_analytics_C52084224(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_apps_open_app_radio_analytics_C52084225(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_apps_onenote_radio_analytics_C52084761(self):
