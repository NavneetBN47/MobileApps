...
class Test_Suite_Pen_Control_Slice6_Pen_Analytics(object):
    ...
    def test_01_pen_control_pen_onoff_radio_analytics_C52120658(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice6_pen_disabled_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_menu_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_fifth_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_fourth_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_middle_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_left_click_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_right_click_radio_button()        
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_erase_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_pen_onoff_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_pen_erase_radio_analytics_C52120663(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_pen_right_click_radio_analytics_C52120659(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_pen_left_click_radio_analytics_C52120660(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_pen_middle_click_radio_analytics_C52120661(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_pen_fourth_click_radio_analytics_C52120662(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_pen_fifth_click_radio_analytics_C52120665(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_pen_menu_radio_analytics_C52120681(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_pen_disabled_radio_analytics_C52120682(self):
