...
class Test_Suite_Pen_Control_Slice3_Productivity_Analytics(object):
    ...
    def test_01_pen_control_productivity_universal_radio_analytics_C52108257(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice3_productivity_go_forward_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_go_back_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_page_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_page_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_redo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_copy_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_undo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_paste_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice3_productivity_universal_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_productivity_paste_radio_analytics_C52108258(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_productivity_undo_radio_analytics_C52108260(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_productivity_copy_radio_analytics_C52108261(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_productivity_redo_radio_analytics_C52108262(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_productivity_page_up_radio_analytics_C52108263(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_productivity_page_down_radio_analytics_C52108264(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_productivity_go_back_radio_analytics_C52108265(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_productivity_go_forward_radio_analytics_C52108266(self):
