...
class Test_Suite_Pen_Control_Slice4_Productivity_Analytics(object):
    ...
    def test_01_pen_control_productivity_universal_radio_analytics_C52113420(self):
        ...
        time.sleep(3)
        self.fc.fd["pen_control"].click_radial_slice4_button()
        time.sleep(3)
        
        self.fc.swipe_window(direction="down", distance=4)
        time.sleep(3)
        self.fc.fd["pen_control"].click_radial_slice4_productivity_show_more_button()
        time.sleep(5)
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice4_productivity_go_forward_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_go_back_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_page_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_page_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_redo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_copy_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_undo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_paste_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice4_productivity_universal_radio_button()
            time.sleep(1)
        ...
        custom_filter = {
        "version": "2.0.0",
        "viewHierarchy": ["base:/", "mfe:/PcPencontrol/Slice4/"],
        "viewName": "Slice4", 
        "viewMode": "",
    ...
    @pytest.mark.analytics
    def test_02_pen_control_productivity_paste_radio_analytics_C52113421(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_productivity_undo_radio_analytics_C52113423(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_productivity_copy_radio_analytics_C52113424(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_productivity_redo_radio_analytics_C52113426(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_productivity_page_up_radio_analytics_C52113427(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_productivity_page_down_radio_analytics_C52113428(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_productivity_go_back_radio_analytics_C52113430(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_productivity_go_forward_radio_analytics_C52114960(self):
