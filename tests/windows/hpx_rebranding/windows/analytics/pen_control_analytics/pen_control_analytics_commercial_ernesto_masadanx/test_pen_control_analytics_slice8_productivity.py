...
class Test_Suite_Pen_Control_Slice8_Productivity_Analytics(object):
    ...
    def test_01_pen_control_productivity_universal_radio_analytics_C52121774(self):
        ...
        time.sleep(3)
        self.fc.fd["pen_control"].click_radial_slice8_button()
        time.sleep(3)
        
        self.fc.swipe_window(direction="down", distance=4)
        time.sleep(3)
        self.fc.fd["pen_control"].click_radial_slice8_productivity_show_more_button()
        time.sleep(5)
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice8_productivity_go_forward_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_go_back_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_page_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_page_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_redo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_copy_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_undo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_paste_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice8_productivity_universal_radio_button()
            time.sleep(1)
        ...
        custom_filter = {
        "version": "2.0.0",
        "viewHierarchy": ["base:/", "mfe:/PcPencontrol/Slice8/"],
        "viewName": "Slice8", 
        "viewMode": "",
    ...
    @pytest.mark.analytics
    def test_02_pen_control_productivity_paste_radio_analytics_C52121776(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_productivity_undo_radio_analytics_C52121777(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_productivity_copy_radio_analytics_C52121778(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_productivity_redo_radio_analytics_C52121779(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_productivity_page_up_radio_analytics_C52121780(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_productivity_page_down_radio_analytics_C52121781(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_productivity_go_back_radio_analytics_C52121782(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_productivity_go_forward_radio_analytics_C52121783(self):
