...
class Test_Suite_Pen_Control_Slice1_Media_Analytics(object):
    ...
    def test_01_pen_control_media_playpause_radio_analytics_C52089468(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice1_media_mute_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_media_volume_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_media_volume_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_media_previous_track_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_media_next_track_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_media_playpause_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_media_next_track_radio_analytics_C52089474(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_media_previous_track_radio_analytics_C52091672(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_media_volume_up_radio_analytics_C52091702(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_media_volume_down_radio_analytics_C52091703(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_media_mute_audio_radio_analytics_C52091704(self):
