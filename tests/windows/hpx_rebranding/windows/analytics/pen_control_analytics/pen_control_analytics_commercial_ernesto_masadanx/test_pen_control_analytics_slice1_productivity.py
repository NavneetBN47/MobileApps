...
class Test_Suite_Pen_Control_Slice1_Productivity_Analytics(object):
    ...
    def test_01_pen_control_productivity_universal_radio_analytics_C52088885(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice1_productivity_go_forward_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_go_back_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_page_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_page_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_redo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_copy_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_undo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_paste_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice1_productivity_universal_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_productivity_paste_radio_analytics_C52088886(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_productivity_undo_radio_analytics_C52088887(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_productivity_copy_radio_analytics_C52088888(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_productivity_redo_radio_analytics_C52088906(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_productivity_page_up_radio_analytics_C52088910(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_productivity_page_down_radio_analytics_C52088911(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_productivity_go_back_radio_analytics_C52088912(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_productivity_go_forward_radio_analytics_C52088913(self):
