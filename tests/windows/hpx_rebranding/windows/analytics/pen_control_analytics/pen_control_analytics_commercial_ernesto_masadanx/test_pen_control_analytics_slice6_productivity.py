...
class Test_Suite_Pen_Control_Slice6_Productivity_Analytics(object):
    ...
    def test_01_pen_control_productivity_universal_radio_analytics_C52120640(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice6_productivity_go_forward_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_go_back_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_page_down_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_page_up_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_redo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_copy_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_undo_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice6_productivity_paste_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_productivity_paste_radio_analytics_C52120646(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_productivity_undo_radio_analytics_C52120649(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_productivity_copy_radio_analytics_C52120650(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_productivity_redo_radio_analytics_C52120651(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_productivity_page_up_radio_analytics_C52120652(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_productivity_page_down_radio_analytics_C52120653(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_productivity_go_back_radio_analytics_C52120656(self):
    ...
    @pytest.mark.analytics
    def test_09_pen_control_productivity_go_forward_radio_analytics_C52120657(self):
