...
class Test_Suite_Pen_Control_Slice7_Apps_Analytics(object):
    ...
    def test_01_pen_control_apps_windows_search_radio_analytics_C52121731(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_radial_slice7_apps_onenote_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_open_app_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice_add_application_cancel_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_email_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_web_browser_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_switch_app_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_screen_snipping_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_ms_whiteboard_radio_button()
            time.sleep(1)
            self.fc.fd["pen_control"].click_radial_slice7_apps_windows_search_radio_button()
            time.sleep(1)
    ...
    @pytest.mark.analytics
    def test_02_pen_control_apps_ms_whiteboard_radio_analytics_C52121732(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_apps_screen_snipping_radio_analytics_C52121733(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_apps_switch_application_radio_analytics_C52121736(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_apps_web_browser_radio_analytics_C52121737(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_apps_email_radio_analytics_C52121738(self):
    ...
    @pytest.mark.analytics
    def test_07_pen_control_apps_open_app_radio_analytics_C52121739(self):
    ...
    @pytest.mark.analytics
    def test_08_pen_control_apps_onenote_app_radio_analytics_C52121740(self):
