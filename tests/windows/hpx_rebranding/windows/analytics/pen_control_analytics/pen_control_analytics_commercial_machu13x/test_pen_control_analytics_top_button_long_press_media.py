...
class Test_Suite_Pen_Control_Top_Button_Long_Press_Media_Analytics(object):
    ...
    def test_01_pen_control_media_playpause_radio_analytics_C52087847(self):
        ...
        for _ in range(5): 
            self.fc.fd["pen_control"].click_customize_mute_audio_text()
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_volume_down_text()
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_volume_up_text()
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_previous_track_text()
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_next_track_text()
            time.sleep(1)
            self.fc.fd["pen_control"].click_customize_play_pause_text()
            time.sleep(1)
        ...
        custom_filter = {
        "version": "2.0.0",
        "viewHierarchy": ["base:/", "mfe:/PcPencontrol/TopbuttonLongpress/"],
        "viewName": "TopbuttonLongpress", 
        "viewMode": "",
    ...
    @pytest.mark.analytics
    def test_02_pen_control_media_next_track_radio_analytics_C52087939(self):
    ...
    @pytest.mark.analytics
    def test_03_pen_control_media_previous_track_radio_analytics_C52088665(self):
    ...
    @pytest.mark.analytics
    def test_04_pen_control_media_volume_up_radio_analytics_C52088696(self):
    ...
    @pytest.mark.analytics
    def test_05_pen_control_media_volume_down_radio_analytics_C52088757(self):
    ...
    @pytest.mark.analytics
    def test_06_pen_control_media_mute_audio_radio_analytics_C52088836(self):
