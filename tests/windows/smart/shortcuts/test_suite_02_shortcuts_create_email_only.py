...
class Test_Suite_02_Shortcuts_Create_Email_Only(object):
    ...
    def test_01_create_shortcuts_by_email_only(self):
        """
    ...
    def test_02_execute_shortcut_no_printer_driver(self):
        ...
        Select the Shortcut with Email destination to execute the Shortcut  
        User should not be prompted with "Install to Print" dialogue
        User should be able to complete the execution flow.
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/16890379(To do since GOTH-23126)
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/16890381
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/29151286
        """ 
