...
class Test_Suite_07_Shortcuts_Print_Email_Save(object):
    ...
    def test_01_create_shortcuts_by_print_email_save(self):
        """
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/13792468   
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/29142884 
        """
        ...
        self.shortcuts.verify_email_icon()
        self.shortcuts.verify_printer_icon()
