...
class Test_Suite_05_Not_Enjoying_Submit_Feedback(object):
    ...
    def test_02_are_you_enjoying_dialog_display(self):
        """
        Perform a scan job and try to save it twice.
        
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959349
        """  
    ...
    def test_03_click_yes_btn_on_sorry_dialog(self):
        """
        On the pop up, click the No button
        Click Yes button on Sorry to Hear
        Fill out form and click Submit feedback
        Click the back arrow
        
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959349
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991972
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991973
        ...
        self.scan.click_sorry_to_dialog_yes_btn()
