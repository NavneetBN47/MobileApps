...
class Test_Suite_04_Not_Enjoying_Click_Not_Now(object):
    ...
    def test_02_are_you_enjoying_dialog_display(self):
        ...
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959348
        """  
    ...
    def test_03_click_not_now_btn_on_sorry_dialog(self):
        """
