...
class Test_Suite_01_Submit_Review(object):
    ...
    def test_02_go_to_scan_preview_screen(self):
        ...
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959345
        """
    ...
    def test_03_save_twice(self):
        ...
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959345
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959346
        """     
        for _ in range(2):
    ...
    def test_04_skip_microsoft_account(self):
        ...
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959345
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991979
        """ 
    ...
    def test_05_submit_review_flow(self):
        """
        Choose a star rating and click 'Add a review' button
        Submit review
        Click the Done button on the Thank You! dialogue box
        "Choose a star rating" dialog box should appear after hitting yes
        "Add a review" Dialog box shows with two text box
        Should be able to successfully submit and be returned to the Scan result page

        https://hp-testrail.external.hp.com/index.php?/cases/view/15959345
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959344
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991968
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991976
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991977
        https://hp-testrail.external.hp.com/index.php?/cases/view/15991978
        """
        ...
        if self.scan.verify_review_thank_you_dialog(raise_e=False):
            self.scan.click_review_done_btn()
