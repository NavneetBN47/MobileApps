...
class Test_Suite_08_User_Onboarding_Tiles_Print_Documents(object):
    ...
    def test_02_user_onboarding_flow_via_print_documents_tile(self, buttons):
        """
        Click "Print Document" tile without signed in, verify OWS UCDE value prop shows for Print Document
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/27731299
