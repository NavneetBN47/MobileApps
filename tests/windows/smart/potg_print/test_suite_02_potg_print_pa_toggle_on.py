...
class Test_Suite_02_Potg_Print_Pa_Toggle_On(object):
    ...
    def test_02_turn_on_printing_anywhere_toggle(self):
        """
        ...
        https://hp-testrail.external.hp.com/index.php?/cases/view/27894515
        """
        ...
        self.printer_settings.switch_private_pickup_toggle(toggle='off')
