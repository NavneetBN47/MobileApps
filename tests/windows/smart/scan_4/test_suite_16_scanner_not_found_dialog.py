...
class Test_Suite_16_Scanner_Not_Found_Dialog(object):
    ...
    def test_02_check_error_dialog_with_offline_printer(self):
        """
        Turn off the printer or change computer network to another one which could not find the printer.
        Click "Scan" button.
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/13235497
        """
        self.fc.trigger_printer_offline_status(self.p)
        self.scan.click_scan_btn()
        self.scan.verify_scanner_not_found_dialog()
    ...
    def test_04_click_scan_button_with_fix_error(self):
        """
        Turn on the printer or change the computer network to the same with printer.
        Click the "Scan" button.
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/13235405
        """
        time.sleep(5)
        self.fc.restore_printer_online_status(self.p)
        self.scan.click_scan_canceled_x_btn()
