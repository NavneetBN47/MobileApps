...
class Test_Suite_11_Pepto_Shortcuts_Single_Option(object):
    ...
    def test_02_create_a_print_shortcut(self):
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14101112    
        """
    ...
    def test_05_check_pepto_data(self):
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14101113
        """ 
        check_event_list = ['"email_selected":"true"'] 

        for each_event in check_event_list:
            self.pepto.check_pepto_data(each_event)

    def test_06_create_a_save_to_shortcut(self):
        """
        Click "Smart Tasks" tile on the Main UI -> verify "Create smart tasks" screen shows
        Click the "Save To" option and create smart tasks with any Save to destination -> Verify smart tasks created successfully

        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14101114
        """ 
        self.driver.launch_app()
        sleep(3)
        self.home.verify_home_screen()
    ...
    def test_07_check_pepto_data(self):
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14101114
        """ 
        check_event_list = ['"saveto_selected":"true"']

        for each_event in check_event_list:
            self.pepto.check_pepto_data(each_event)

    def test_08_shortcuts_cleanup(self):
