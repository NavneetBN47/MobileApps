...
class Test_Suite_10_Click_Back_Arrow_Time_Back(object):
    ...
    def test_04_click_back_arrow_flow(self):
        """
        ...
        Pop up should say "Are you enjoying the HP smart app?"
        Back arrow should return user to Scan Results screen

        https://hp-testrail.external.hp.com/index.php?/cases/view/15959361
        https://hp-testrail.external.hp.com/index.php?/cases/view/15959355
        """
