...
class Test_Suite_15_Shortcuts_printer_related_messages_not_install_driver_1(object):
    ...
    def test_02_check_printer_problem_without_printer_driver(self):
        """
       Execute Shortcut (Print destination only) from Scan Preview screen or from Shortcut home screen.
       Verify the "Printer Problem" dialog shows with "Return to Home" and "Cancel" button.
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14102988
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103007
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103001(low)
        """
    ...
    def test_03_fix_issue_re_execute_shortcut(self):
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103012
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103096(high)
        """
