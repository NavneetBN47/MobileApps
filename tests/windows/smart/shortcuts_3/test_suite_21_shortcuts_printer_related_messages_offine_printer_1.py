...
class Test_Suite_21_Shortcuts_printer_related_messages_offline_printer_1(object):
    ...
    def test_02_check_printer_problem_with_offline_printer(self):
        ...
        Verify the "Printer is offline" dialog shows with "Cancel" button.
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14160490
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14225884
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14160491(low)
        """
        ...
        self.shortcuts.verify_printer_offline_dialog("Print destination only")
