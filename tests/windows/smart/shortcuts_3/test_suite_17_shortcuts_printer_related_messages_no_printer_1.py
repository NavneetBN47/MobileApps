...
class Test_Suite_17_Shortcuts_printer_related_messages_no_printer_1(object):
    ...
    def test_02_check_printer_problem_no_printer(self):
        ...
        Verify the "Printer problem" dialog shows with "Cancel" button
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103099
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103103
                  -> https://hp-testrail.external.hp.com/index.php?/cases/view/14103101(low)
        """
        ...
        self.shortcuts.verify_printer_problem_dialog("Print destination only", no_printer=True)
