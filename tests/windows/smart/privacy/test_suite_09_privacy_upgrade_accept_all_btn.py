...
class Test_Suite_09_Privacy_Upgrade_Accept_All_Btn(object):
    ...
    def test_01_install_ms_store_hp_smart(self):
        ...
        self.welcome.verify_welcome_screen(timeout=60)
        self.fc.go_home()
    ...
    def test_02_check_app_go_to_home_screen(self):
        """
        [Upgrade only] Click Accept all button on the welcome screen after upgrade, verify user is taken to home page

        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/29223906
                -> https://hp-testrail.external.hp.com/index.php?/cases/view/29223923
        """
