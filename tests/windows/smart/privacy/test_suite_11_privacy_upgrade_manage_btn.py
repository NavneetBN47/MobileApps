...
class Test_Suite_11_Privacy_Upgrade_Manage_Btn(object):
    ...
    def test_02_check_app_go_to_home_screen(self):
        """
        [Upgrade only] Click "Continue" button on the "Manage your HP Smart privacy preference" screen, verify user is taken to home page

        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/29223909
        """
