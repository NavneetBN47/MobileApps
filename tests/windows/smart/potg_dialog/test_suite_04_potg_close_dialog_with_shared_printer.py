...
class Test_Suite_04_Potg_Close_Dialog_With_Shared_Printer(object):
    ...
    def test_02_click_x_btn(self):
        """
        Wait the Optimize dialog with "Learn More" button screen display.

        https://hp-testrail.external.hp.com/index.php?/cases/view/28256417 (Step 6-7)

        Click "X" button on the optimize dialog with learn more button.
        Verify the Optimize dialog disappear.

        https://hp-testrail.external.hp.com/index.php?/cases/view/28249329 (#1)
        """
