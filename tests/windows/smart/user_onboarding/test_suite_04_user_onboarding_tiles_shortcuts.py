...
class Test_Suite_04_User_Onboarding_Tiles_Shortcuts(object):
    ...
    def test_02_user_onboarding_flow_via_shortcuts_tile(self, buttons):
        """
        Click "Shortcuts" tile without signed in, verify OWS UCDE value prop shows for Shortcuts
        ...
        TestRails -> https://hp-testrail.external.hp.com/index.php?/cases/view/27731301
