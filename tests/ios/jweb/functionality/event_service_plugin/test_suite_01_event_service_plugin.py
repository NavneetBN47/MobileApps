...
class Test_Suite_01_Event_Service_Plugin(object):
    ...
    def test_01_subscribe_to_valid_event(self, create_and_select_new_subscriber):
        """
        C29223599: Subscribe to an event using valid eventName and publisherID, expecting 'Subscription was created' toast notification
    ...
    def test_07_delete_a_subscriber(self):
        """
    ...
    def test_08_delete_first_subscriber_from_subscriber_list(self, subscribers):
        """
    ...
    def test_09_delete_a_publisher(self):
        """
    ...
    def test_10_create_three_subscriber_with_same_valid_fields_with_persistant_value_false(self, subscribers):
        """
    ...
    @pytest.mark.parametrize("subscribers", [("test0", "test1", "test2")])
    def test_11_create_three_subscriber_with_same_valid_fields_with_persistant_value_true(self, subscribers):
        """
    ...
    def test_12_verify_pause_resume_options_ispersistent_if_false(self):
        """
    ...
    def test_13_verify_pause_resume_options_ispersistent_if_true(self):
        """
    ...
    def test_14_subscribe_an_event_with_valid_event_name_publisher_id(self, create_and_select_new_subscriber):
        """
