...
class Test_Suite_01_HPX_Mfe(object):
    ...
    def test_01_verify_mfe(self):
        ...
        assert self.home.get_lets_get_started_text() == "Let’s get started!", "Title is not as expected"
        assert self.home.get_lets_get_started_sub_text() == "Add your printer to get started", "Sub text is not as expected"
