...
class TestECPartnerLinkPage(object):
    ...
    def test_01_partner_link_page(self):
        ...
        self.ecp_flow.verify_finish_setup_ecp_header()
        self.p_oobe.verify_left_panel_printer_container(biz=self.biz_model, printer_profile=self.printer_profile)
        self.ecp_flow.verify_get_software_and_drivers()
        self.ecp_flow.verify_connect_to_hp_partner_link_pay_per_use()
        self.ecp_flow.verify_hp_command_center_finish_setup_page()
        self.ecp_flow.click_get_drivers_button()
        self.driver.add_window("support_drivers_page")
        if not self.driver.switch_window("support_drivers_page"):
            # Sometimes you need to do it twice to switch window
            self.driver.switch_window("support_drivers_page")
        self.p_oobe_new_tab = PortalOOBE(self.driver, "pn", "support_drivers_page")
        self.p_oobe_new_tab.verify_support_drivers_page()
        self.driver.close_window("support_drivers_page")
        ...
        self.fc.verify_ecp_command_center_dashboard()
