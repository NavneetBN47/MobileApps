...
class Test_hp_one_horizon(object):
    ...
    def class_setup(self, web_session_setup, request):
        ...
        """
        This is HP one Horizon POC Flow.
        Accept II and Check No Fw update Choice Screen both Flex & E2E.
        """

    def test_01_horizon_accept_ink_no_FW_update_screen_flow(self):
        ...
        self.ows_fc.navigate_instant_ink(enroll=True, timeout=40)
        self.ows_fc.navigate_ows(self.ows_printer)
        assert self.firmware_update_choice.verify_firmware_update_choice_page(raise_e=False, timeout=30) is False
