...
class Test_04_Workforce_Standard_Lost_Device_Admin_Permisson_Set(object):
    ...
    def class_setup(self, wex_setup, request):
        ...
        self.hpid_username = self.account["std_lost_device_admin_email"]
        self.hpid_password = self.account["std_lost_device_admin_password"]

    def test_01_verify_std_lost_device_admin_permission_set_for_home_page(self):
        #
        ...
        soft_assertion.generate_report("Test Results - Home Page", "Standard Lost Device Admin")
 
        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_home_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")

    def test_02_verify_std_lost_device_admin_permission_set_for_analytics_dashboards_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Analytics Dashboards Page", "Standard Lost Device Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_analytics_dashboards_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")
    
    def test_03_verify_std_lost_device_admin_permission_set_for_modern_reports(self): 
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        #Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Modern Reports", "Standard Lost Device Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_modern_reports.txt", title="Soft Assert Report", message="Standard Lost Device Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")

    def test_04_verify_std_lost_device_admin_permission_set_for_classic_reports(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Classic Reports", "Standard Lost Device Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_classic_reports.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
    ...
    def test_06_verify_std_lost_device_admin_permission_set_for_groups(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Groups Page", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_groups_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")

    def test_07_verify_std_lost_device_admin_permission_set_for_remediations(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Remediations Page", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_remediations_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")
    
    def test_08_verify_std_lost_device_admin_permission_set_for_pulses_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Pulses", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_help_and_support_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")
    
    def test_09_verify_std_lost_device_admin_permission_set_for_alerts_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Alerts", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="reports_alerts_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")

    def test_10_verify_std_lost_device_admin_permission_set_for_scripts_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Scripts", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="reports_scripts_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")
    
    def test_11_verify_std_lost_device_admin_permission_set_for_labs_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Labs", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="reports_labs_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
    ...
    def test_13_verify_std_lost_device_admin_permission_set_for_account_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Accounts", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_accounts_page.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")

    def test_14_verify_std_lost_device_admin_permission_set_for_settings_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        soft_assertion.assert_false(self.settings.verify_settings_page(), "Settings page")
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Settings Tabs", "Standard Lost Device Admin")
        
        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_settings_tabs.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
        
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")

    def test_15_verify_std_lost_device_admin_permission_user_profile_overview_and_communication_preferences_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - User Profile", "Standard Lost Device Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_user_profile.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")
    
    def test_16_verify_std_lost_device_admin_permission_set_for_onboarding_notifications(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Onboarding Notifications", "Standard Lost Device Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_onboaring_notifications.txt", title="Soft Assert Report", message="Standard Lost Device Admin")
        
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Standard Lost Device Admin")
    
    def test_17_verify_std_lost_device_admin_permission_set_for_help_and_support_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Help and Support Page", "Standard Lost Device Admin")
