...
class Test_11_Workforce_Proplus_Active_Care_Connector_Admin_Permisson_Set(object):
    ...
    def class_setup(self, wex_setup, request):
        ...
        self.hpid_username = self.account["pro_plus_active_care_connector_admin_email"]
        self.hpid_password = self.account["pro_plus_active_care_connector_admin_password"]

    def test_01_verify_pro_plus_active_care_connector_admin_permission_set_for_home_page(self):
        #
        ...
        soft_assertion.generate_report("Test Results - Home Page", "Pro+ Active Care Connector Admin")
 
        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_home_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_02_verify_pro_plus_active_care_connector_admin_permission_set_for_devices_menu(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        ...
        soft_assertion.assert_false(self.home.verify_sidemenu_devices_button(), "Side menu Devices button")
        soft_assertion.assert_false(self.home.verify_sidemenu_devices_view_pcs_button(),"Side menu Devices - View PCs button")
        soft_assertion.assert_false(self.home.verify_sidemenu_devices_view_virtual_machines_button(),"Side menu Devices - View Virtual Machines button")
        soft_assertion.assert_false(self.home.verify_sidemenu_devices_view_physical_assets_button(),"Side menu Devices - View Physical Assets button")
        ...
        soft_assertion.assert_false(self.printers.verify_devices_view_pcs_page(),"Devices - View PCs page")
        ...
        soft_assertion.assert_false(self.printers.verify_export_pcs_button(),"Export PCs button")
 
        # Perform soft assertions on Devices- View Virtual Machines page
        soft_assertion.assert_false(self.printers.verify_devices_view_virtual_machines_page(),"Devices - View Virtual Machines page")
        ...
        soft_assertion.assert_false(self.printers.verify_export_virtual_machines_button(),"Export Virtual Machines button")
 
        # Perform soft assertions on Devices- View Physical Assets page
        soft_assertion.assert_false(self.printers.verify_devices_view_physical_assets_page(),"Devices - View Physical Assets page")
        ...
        soft_assertion.assert_false(self.printers.verify_export_physical_assets_button(),"Export Physical Assets button")

        #Generate report for soft assertions
        soft_assertion.generate_report("Test Results- Devices Page", "Pro+ Active Care Connector Admin")
 
        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_devices_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_03_verify_pro_plus_active_care_connector_admin_permission_set_for_groups(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Groups Page", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_groups_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")
    
    def test_04_verify_pro_plus_active_care_connector_admin_permission_set_for_remediations(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Remediations Page", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_remediations_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_05_verify_pro_plus_active_care_connector_admin_permission_user_profile_overview_and_communication_preferences_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - User Profile", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_user_profile.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")
    
    def test_06_verify_pro_plus_active_care_connector_admin_permission_set_for_help_and_support_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Help and Support Page", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_help_and_support_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")
    
    def test_07_verify_pro_plus_active_care_connector_admin_permission_set_for_settings_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Settings Tabs", "Pro+ Active Care Connector Admin")
        
        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_settings_tabs.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
        
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_08_verify_pro_plus_active_care_connector_admin_permission_set_for_analytics_dashboards_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Analytics Dashboards Page", "Pro+ Active Care Connector Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_analytics_dashboards_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_09_verify_pro_plus_active_care_connector_admin_permission_set_for_modern_reports(self): 
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        #Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Modern Reports", "Pro+ Active Care Connector Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_modern_reports.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_10_verify_pro_plus_active_care_connector_admin_permission_set_for_classic_reports(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Classic Reports", "Pro+ Active Care Connector Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_classic_reports.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_11_verify_pro_plus_active_care_connector_admin_permission_set_for_account_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Accounts", "Pro+ Active Care Connector Admin")
    ...
    def test_12_verify_pro_plus_active_care_connector_admin_permission_set_for_pulses_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Pulses", "Pro+ Active Care Connector Admin")
    ...
    def test_13_verify_pro_plus_active_care_connector_admin_permission_set_for_integrations_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        soft_assertion.assert_true(self.integrations.verify_integrations_page_entra_id_accounts_widget(), "Integrations page - Enter ID Accounts widget")

        soft_assertion.assert_true(self.integrations.verify_integrations_page_service_now_widget_connect_button(), "Integrations page - Service Now Connector widget - Connect button")
        soft_assertion.assert_true(self.integrations.verify_integrations_page_power_bi_widget_configure_button(), "Integrations page - Power BI widget - Configure button")
        soft_assertion.assert_true(self.integrations.verify_integrations_page_power_automate_widget_connect_button(), "Integrations page - Power Automate widget - Connect button")
        soft_assertion.assert_true(self.integrations.verify_integrations_page_tableau_widget_configure_button(), "Integrations page - Tableau widget - Configure button")
        soft_assertion.assert_true(self.integrations.verify_integrations_page_entra_id_group_widget_connect_button(), "Integrations page - Entra ID Groups widget - Connect button")
        soft_assertion.assert_true(self.integrations.verify_integrations_page_entra_id_account_widget_connect_button(), "Integrations page - Enter ID Accounts widget - Connect button")
        soft_assertion.assert_false(self.integrations.verify_integrations_page_entra_id_accounts_widget_upgrade_button(), "Integrations page - Enter ID Accounts widget - Upgrade button")
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Integrations", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_integrations_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_14_verify_pro_plus_active_care_connector_admin_permission_set_for_alerts_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Alerts", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="reports_alerts_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
 
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")
    
    def test_15_verify_pro_plus_active_care_connector_admin_permission_set_for_labs_page(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        if self.home.verify_side_menu_expand_button_is_displayed() is False:
            self.home.click_side_menu_expand_button()
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Labs", "Pro+ Active Care Connector Admin")

        # # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="reports_labs_page.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")

        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_16_verify_pro_plus_active_care_connector_admin_permission_set_for_onboarding_notifications(self):
        #
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        soft_assertion.assert_false(self.home.verify_troubleshoot_device_issues_button(), "Onboarding Notification - Troubleshoot Device Issues button")
        ...
        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Onboarding Notifications", "Pro+ Active Care Connector Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_onboaring_notifications.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
        
        # Raise exception if any soft assertions failed
        soft_assertion.raise_assertion_errors("Pro+ Active Care Connector Admin")

    def test_17_verify_pro_plus_active_care_connector_admin_permission_set_for_notification_center(self):
        # 
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password)
        soft_assertion.clear()
        ...
        soft_assertion.assert_false(self.home.verify_notification_center_alerts_message(), "Notification Center - Alerts message")
        soft_assertion.assert_false(self.home.verify_notification_center_notifications_message(), "Notification Center - Notifications message")

        # Generate report for soft assertions
        soft_assertion.generate_report("Test Results - Notification Center", "Pro+ Active Care Connector Admin")

        # Export report to txt file
        # soft_assertion.export_report_to_txt(filename="report_notifications_center.txt", title="Soft Assert Report", message="Pro+ Active Care Connector Admin")
