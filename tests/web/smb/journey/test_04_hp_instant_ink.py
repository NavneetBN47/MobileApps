...
class Test_04_Users(object):
    ...
    def test_01_verify_hp_instant_mfe(self):
        #https://hp-testrail.external.hp.com/index.php?/cases/view/32799334    
        #Verify that the hp instant ink page loads
    ...
    def test_02_verify_signup_now_button(self):
        #https://hp-testrail.external.hp.com/index.php?/cases/view/32804618
        #verify hp instant ink sign up option 
        logging.info("Using account: {self.hpid_username}")
        self.fc.go_home(self.stack, self.hpid_username, self.hpid_password, self.hpid_tenantID, self.locale)
        self.home.verify_smb_home_title_bar()
        if self.hpinstantink.verify_signup_now_button() is not False:
            ...
            logging.info("HP Instant INK is enrolled for this printer")