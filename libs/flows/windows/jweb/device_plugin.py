...
class DevicePlugin(JwebFlow):
    ...
    def return_device_info(self):
        ...
        """
        return json.loads(self.driver.wait_for_object("device_info_test_result", displayed=False).text)

    def return_language_test_result(self):
        """
        :return: text result text under Device.getLanguageCode() 
        """
        return json.loads(self.driver.wait_for_object("language_test_result", displayed=False).text)
