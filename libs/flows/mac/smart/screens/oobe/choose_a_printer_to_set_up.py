...
class ChooseAPrinterToSetUp(SmartScreens):
    folder_name = "oobe"
    flow_name = "choose_a_printer_to_set_up"
    ...
    def __init__(self, driver):
        ...
        :return:
        '''
        super(ChooseAPrinterToSetUp, self).__init__(driver)
...
# -------------------------------Operate Elements--------------------------------------------------
    def wait_for_screen_load(self, timeout=30, raise_e=True):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[wait_for_screen_load]-Wait for screen loading... ")
    ...
    def wait_for_busy_icon_display(self, timeout=30, raise_e=True):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[wait_for_busy_icon_display]-Wait for screen loading... ")
    ...
    def wait_for_busy_icon_disappear(self, timeout=30, raise_e=True):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[wait_for_busy_icon_disappear]-Wait for screen loading... ")
    ...
    def click_refresh_link(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[click_refresh_link]-Click Refresh link.. ")
    ...
    def click_printer_not_listed_link(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[click_printer_not_listed_link]-Click Printer not listed link.. ")
    ...
    def click_to_select_the_first_printer(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[select_the_first_printer]-click to select the first printer.. ")
    ...
    def click_to_selected_printer(self, printer_name):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[click_to_selected_printer]-click to select printer.. ")
...
#             self.driver.click("beaconing_printer_chosed", format_specifier=[printer_name], is_native_event=True)
    ...
    def get_value_of_select_a_printer_title(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_select_a_printer_title]-Get the contents of Select a printer screen title...  ")
    ...
    def get_value_of_select_a_printer_content_1(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_select_a_printer_content_1]-Get the contents of Select a printer screen content - 1...  ")
    ...
    def get_value_of_select_a_printer_content_2(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_select_a_printer_content_2]-Get the contents of Select a printer screen content - 2...  ")
    ...
    def get_value_of_select_a_printer_content_3(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_select_a_printer_content_3]-Get the contents of Select a printer screen content - 3...  ")
    ...
    def get_value_of_select_a_printer_content_4(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_select_a_printer_content_4]-Get the contents of Select a printer screen content - 4...  ")
    ...
    def get_value_of_refresh_link(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_refresh_link]-Get the contents of Refresh link...  ")

        return self.driver.get_title("refresh_link")
    ...
    def get_value_of_printer_not_listed_link(self):
        ...
        :return:
        '''
        logging.debug("[ChooseAPrinterToSetUp]:[get_value_of_printer_not_listed_link]-Get the contents of Printer not list link...  ")

        return self.driver.get_title("printer_not_listed_link")
...
# -------------------------------Verification Methods--------------------------
    def verify_select_a_printer_screen(self):
        ...
        test_strings = smart_utility.get_local_strings_from_table(screen_name='select_a_printer_screen')
        assert self.get_value_of_select_a_printer_title() == test_strings['select_a_printer_title']
        assert self.get_value_of_select_a_printer_content_1() == test_strings['select_a_printer_content_1']
        assert self.get_value_of_select_a_printer_content_2() == test_strings['select_a_printer_content_2']
        assert self.get_value_of_select_a_printer_content_3() == test_strings['select_a_printer_content_3']
        assert self.get_value_of_select_a_printer_content_4() == test_strings['select_a_printer_content_4']
        assert self.get_value_of_refresh_link() == test_strings['refresh_link']
        assert self.get_value_of_printer_not_listed_link() == test_strings['printer_not_listed_link']
