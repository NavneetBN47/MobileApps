...
class ServiceRoutingDevSettings(JwebServiceRoutingFlow):
    flow_name = "service_routing_dev_settings"

    def open_select_settings_page(self):
        """
        Launch Select Settings Page Screen
        """
        self.driver.start_activity(PACKAGE.JWEB_SERVICE_ROUTING, LAUNCH_ACTIVITY.JWEB_SERVICE_ROUTING_DEV_SETTINGS)
